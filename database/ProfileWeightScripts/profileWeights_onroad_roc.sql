...
CREATE TABLE IF NOT EXISTS ##newDB##.base_schema (
	...
	PRIMARY KEY (countyID, monthID, SMOKE_SCC, SMOKE_mode, pollutantID, pollutantName, GROCCode)
);
...
CREATE TABLE IF NOT EXISTS ##newDB##.exh_croc (
	...
	PRIMARY KEY (countyID, monthID, SMOKE_SCC, SMOKE_mode, pollutantID, pollutantName, CROCCode)
);
...
CREATE TABLE ##newDB##.togspeciation
	SELECT fuelSubtypeID,regClassID,processID,minModelYearID,maxModelYearID,GROCCode,GROCNMOGRatio 
	FROM ##defDB##.rocspeciation;

DROP TABLE IF EXISTS ##newDB##.pmspeciation;
CREATE TABLE ##newDB##.pmspeciation
	SELECT fuelSubtypeID,regClassID,processID,minModelYearID,maxModelYearID,CROCCode,CROCOMRatio
	FROM ##defDB##.rocspeciation;
...
INSERT INTO ##newDB##.exh_groc (countyID, monthID, SMOKE_SCC, SMOKE_mode, pollutantID, pollutantName, GROCCode, profileContribution, weightedGROCNMOGRatio)
	...
	GROUP BY t1.monthID, t1.countyID, t1.yearID, t1.monthID, t1.SMOKE_SCC, t1.GROCCode;

TRUNCATE ##newDB##.epm_groc;
INSERT INTO ##newDB##.epm_groc (countyID, monthID, SMOKE_SCC, SMOKE_mode, pollutantID, pollutantName, GROCCode, profileContribution, weightedGROCNMOGRatio)
	SELECT t1.countyID, t1.monthID, t1.SMOKE_SCC, t1.SMOKE_mode,  
		t1.pollutantID, 'Residual TOG (NonHAPTOG)' as pollutantName,  	
		t1.GROCCode,
		COALESCE(SUM(weightedMonthlyEmissions) / NULLIF(total, 0), 0) as profileContribution,
...
INSERT INTO ##newDB##.evp_groc (countyID, monthID, SMOKE_SCC, SMOKE_mode, pollutantID, pollutantName, GROCCode, profileContribution, weightedGROCNMOGRatio)
	SELECT t1.countyID, t1.monthID, t1.SMOKE_SCC, t1.SMOKE_mode,
		t1.pollutantID, 'Residual TOG (NonHAPTOG)' as pollutantName,  	
		t1.GROCCode, 
		COALESCE(SUM(weightedMonthlyEmissions) / NULLIF(total, 0), 0) as profileContribution,
...
INSERT INTO ##newDB##.rfl_groc (countyID, monthID, SMOKE_SCC, SMOKE_mode, pollutantID, pollutantName, GROCCode, profileContribution, weightedGROCNMOGRatio)
	SELECT t1.countyID, t1.monthID, t1.SMOKE_SCC, t1.SMOKE_mode, 
		t1.pollutantID, 'Residual TOG (NonHAPTOG)' as pollutantName, 	
		t1.GROCCode, 
		COALESCE(SUM(weightedMonthlyEmissions) / NULLIF(total, 0), 0) as profileContribution,
...
REPLACE INTO ##newDB##.exh_groc 
	SELECT countyID, moay.monthID, SMOKE_SCC, SMOKE_mode, pollutantID, pollutantName, GROCCode, profileContribution, weightedGROCNMOGRatio
...
INSERT INTO ##newDB##.exh_croc (countyID, monthID, SMOKE_SCC, SMOKE_mode, pollutantID, pollutantName, CROCCode, profileContribution, weightedCROCOMRatio)
	SELECT t1.countyID, t1.monthID, t1.SMOKE_SCC, 'EXH_CROC' as SMOKE_mode, 
	...
	GROUP BY t1.monthID, t1.countyID, t1.yearID, t1.monthID, t1.SMOKE_SCC, t1.CROCCode;

TRUNCATE ##newDB##.exh_residpm;
INSERT INTO ##newDB##.exh_residpm (countyID, monthID, SMOKE_SCC, SMOKE_mode, pollutantID, pollutantName, CROCCode, profileContribution)
	SELECT t1.countyID, t1.monthID, t1.SMOKE_SCC, 'EXH_PM' as SMOKE_mode, 
		...
		t1.CROCCode, 
		COALESCE(SUM(weightedMonthlyEmissions) / NULLIF(totalResid, 0), 0) as profileContribution
	FROM ##newDB##.residpm_speciated_smoke t1
	JOIN (SELECT countyID, yearID, monthID, SMOKE_SCC, 
			sum(weightedMonthlyEmissions) as totalResid
