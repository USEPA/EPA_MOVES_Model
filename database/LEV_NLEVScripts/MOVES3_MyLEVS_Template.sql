-- ###################################################################
-- Template name: MOVES3_MyLEVs_Template.sql
-- Template date: 2/26/2020
-- 
-- This is a template script to be used in conjunction with the LEV
-- Tool in MOVES3. To access the tool, open the Tools menu in MOVES, 
...
-- the save location and few file name. Then, edit the final command
...
-- (for example, in MySQL Workbench), you will need to replace
