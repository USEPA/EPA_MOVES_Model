-- ###################################################################
-- Template name: MOVES5_MyLEVs_Template.sql
-- Template date: 07/27/2023
-- 
...
-- Model years 2031-2050 appear in this script twice: as individual
--       model years, and also as the group 2031-2050. If these years
--       are not covered by the LEV program, you will need to delete
--       both the individual years and the grouped years.
