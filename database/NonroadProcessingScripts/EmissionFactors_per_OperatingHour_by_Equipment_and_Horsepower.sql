...
create index index1 on hours (MOVESRunID,yearID,monthID,dayID,stateID,countyID,SCC,hpID);
...
-- Get hours by equipment type and hpID
...
drop table if exists EmissionFactors_per_operatinghour_by_Equipment_and_Horsepower;
create table EmissionFactors_per_operatinghour_by_Equipment_and_Horsepower
select
	b1.MOVESRunID,
	b1.yearID,
	b1.monthID,
