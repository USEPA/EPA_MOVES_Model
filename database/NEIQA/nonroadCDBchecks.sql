...
DROP   PROCEDURE IF EXISTS NEI_QA_NR;
BeginBlock
CREATE PROCEDURE NEI_QA_NR()
BEGIN
...
declare dataBaseName char(30) COLLATE utf8_general_ci;
   ...
   select '  .. nonroadCDBchecks.sql',curTime(), database();
...
select '  .. nonroadCDBchecks.sql Done', @nErrors, @nWarnings;
