...
public class BuildLEVNLEV extends JDialog implements ActionListener {
	...
	public static final int LEV_MODE = 0;
	/** Mode building an NLEV input database **/
	public static final int NLEV_MODE = 1;
	...
	**/
	public BuildLEVNLEV(JFrame parent, int modeToUse) {
		super(parent, modeToUse == LEV_MODE ? MOVESWindow.MOVES_VERSION + " - Build LEV Database" : MOVESWindow.MOVES_VERSION + " - Build NLEV Database");
		frame = parent;
		mode = modeToUse;
		switch(mode) {
			case LEV_MODE:
