...
/**
 * Interface for all importer modules that participate in the Project Domain Manager.
 * 
 * @author		wgfaler
 * @version		2008-11-15
**/
public interface IProjectDataImporter {
	/**
	...
	**/
	RunSpecSectionStatus getProjectDataStatus(Connection db) throws Exception;
}
