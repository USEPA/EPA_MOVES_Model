...
/**
 * Modifies ELDB based on user parameters.
 * ELDB is the Execution Location Database explained in TotalActivityGenerator

 * @author		Wesley Faler
 * @version		2007-02-13
**/
public class FuelControlStrategy extends InternalControlStrategy {
	/**
	 * Default constructor
	**/
	public FuelControlStrategy() {
	}
	...
	**/
	...
	/**
	 * MasterLoopable override that performs database processing.
