/**************************************************************************************************
 * @(#)SourceUsageControlStrategy.java
 *
 *
 *
 *************************************************************************************************/
...
/**
 * This modifies ELDB based on user parameters.
 * ELDB is the Execution Location Database explained in TotalActivityGenerator
 *
 * @author		Cimulus
 * @version		2007-02-13
**/
public class SourceUsageControlStrategy extends InternalControlStrategy {
	/** Default constructor **/
	public SourceUsageControlStrategy() {
	}
